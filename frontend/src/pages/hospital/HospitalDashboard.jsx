  ...
  useEffect(() => {
    const fetchHospitalData = async () => {
      try {
        ...
        const profileRes = await api.get("/facility/profile");
        ...
        // Fetch blood stock
        const stockRes = await api.get("/hospital/blood/stock");

        // Fetch blood requests
        const requestsRes = await api.get("/hospital/blood/requests");
